...
### Option 1: PythonAnywhere (бесплатный тариф)
...
### Option 2: Heroku (бесплатный тариф)
...
- `pythonanywhere_config.md` - Подробная инструкция для развертывания на PythonAnywhere
